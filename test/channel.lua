...
local s1,s2,s3=clp.spawn(),clp.spawn(),clp.spawn()
...
local s=clp.spawn(function(msg) print('hello',msg) resp:put(msg) end, function (e) print('err',resp:close()) return e end):spawn(4)('john')('paul')('george')('ringo')
s:input():close()
local function f()
